...
pub(crate) fn resolve_skill_command_tool_identifier(
    paths: &VaultPaths,
    name: &str,
    options: &CustomToolRegistryOptions,
...
pub(crate) fn skill_command_tool_name(skill_name: &str, command_id: &str) -> String {
    format!(
        "skill_{}_{}",
...
pub(crate) fn command_matches_allowed_packs(
    packs: &[String],
    options: &CustomToolRegistryOptions,
) -> bool {
