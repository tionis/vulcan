...
#[derive(Debug, Deserialize, Default)]
pub(super) struct PartialPublishConfig {
    pub(super) outline: Option<PartialOutlinePublishConfig>,
}
...
pub(super) struct PartialTemplatesConfig {
    ...
    pub(super) ignore_folders_on_creation: Option<Vec<TemplaterIgnoredFolderConfig>>,
