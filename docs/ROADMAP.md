...
- [x] Keep default Outline publication output compact with phase totals and an aggregate action summary; reserve per-path progress and routine action listings for `--verbose` while always showing conflicts.
