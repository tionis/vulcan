...
- [x] Make focused Outline pull path planning portable across Unicode-normalizing and case-insensitive filesystems, sanitize Windows-reserved/overlong generated names, reject orphaned hierarchy, and parse/rewrite inline or reference-style attachment/document links through the Markdown event stream.
