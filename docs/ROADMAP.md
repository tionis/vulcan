...
- [x] Move TaskNotes and inline-task mutation workflows out of `vulcan-cli`: task add/create/set/reschedule/complete/archive, note/line conversion, shared NLP/default resolution, time-tracking, and pomodoro workflows now live in reusable `vulcan-app` services
