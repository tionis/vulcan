...
`vulcan-app::notes` resolves vault and direct Markdown targets and owns `note_outline` reports for CLI and MCP. Remaining `note_get` and other tool workflows, resource listings/help/custom-tool resources,
