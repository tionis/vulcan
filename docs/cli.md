...
- `vulcan agent install [--overwrite]`: install or refresh the bundled `AGENTS.md` template and default `.agent/skills/<name>/SKILL.md` files for external agent harnesses.
