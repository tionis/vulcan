...
use vulcan_core::{
    ...
    ChangeReport, CheckpointRecord, DataviewJsOutput, DataviewJsResult, DoctorDiagnosticIssue,
    ...
    GraphTrendsReport, HtmlRenderOptions, ImportTarget, InitSummary, LinkSuggestion,
