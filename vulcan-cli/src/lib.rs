...
pub use cli::{
    ...
    CheckpointCommand, Cli, ClonePlatformArg, ColorMode, Command, ConfigAliasCommand,
    ConfigCommand, ConfigImportArgs, ConfigImportCommand, ConfigImportSelection,
    ConfigPermissionsCommand, ConfigPermissionsProfileCommand, ConfigTargetArg, DailyCommand,
    DataviewCommand, DescribeFormatArg, EpubTocStyle, ExchangeCommand, ExportArgs, ExportCommand,
    ExportFormat, ExportProfileCommand, ExportProfileFormatArg, ExportProfileRuleCommand,
    ExportQueryArgs, ExportTransformArgs, FolderNotePlacementArg, GitCommand, GraphCommand,
    GraphExportFormat, IndexCommand, InitArgs, IntegrationCommand, KanbanCommand, McpToolPackArg,
    McpToolPackModeArg, McpTransportArg, NoteAppendPeriodicArg, NoteCheckboxState, NoteCommand,
    NoteGetMode, OutlineBlockReferencePolicyArg, OutlineCollectionPermissionArg,
        ...
        Command::Mcp {
            ...
            mcp::run_mcp(
                ...
                &mcp::McpHttpOptions {
                    ...
                    oauth_local_redirect_uri: oauth_local_redirect_uri.clone(),
