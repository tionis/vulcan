...
pub(crate) use commands::note::{
    ...
    run_note_create_with_body, run_note_patch_command, run_note_set_with_content,
    NoteAppendOptions, NotePatchOptions,
};
#[cfg(test)]
...
pub use cli::{
    ...
    ConfigPermissionsCommand, ConfigPermissionsProfileCommand, ConfigTargetArg, DaemonAgentKindArg,
    DaemonCommand, DaemonCompanionCommand, DaemonConfigCommand, DaemonWebhookFormatArg,
    DailyCommand, DataviewCommand, DescribeFormatArg, EpubTocStyle, ExchangeCommand, ExportArgs,
