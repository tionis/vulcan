...
use vulcan_core::{
    ...
    rename_alias, rename_block_ref, rename_heading, rename_property, render_note_fragment_html,
    render_note_html, render_vault_html, repair_fts, resolve_note_reference,
